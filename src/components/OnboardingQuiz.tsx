...
const OnboardingQuiz: React.FC<OnboardingQuizProps> = ({ onComplete, loading }) => {
      ...
      case 'text':
        return (
          <textarea
            ...
            className="w-full p-4 border-2 border-gray-200 rounded-2xl focus:border-indigo-500 focus:outline-none resize-none h-32"
          />
        );
  ...
  const getStepIcon = (stepIndex: number) => {
    switch (stepIndex) {
      ...
      case 1: return <Home className="w-6 h-6" />;
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20">
          ...
          <div className="flex justify-between items-center mt-12">
            ...
            <button
              ...
              className="flex items-center space-x-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-3 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
